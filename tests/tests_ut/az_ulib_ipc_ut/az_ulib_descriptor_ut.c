...
static void az_ulib_descriptor_interface_descriptor_succeed(void** state)
{
  ...
  /* Interface. */
  assert_true(az_span_is_content_equal(
      MY_INTERFACE._internal.pkg_name, AZ_SPAN_FROM_STR(MY_PACKAGE_1_NAME)));
  assert_int_equal(MY_INTERFACE._internal.pkg_version, MY_PACKAGE_1_VERSION);
  assert_true(az_span_is_content_equal(
      MY_INTERFACE._internal.intf_name, AZ_SPAN_FROM_STR(MY_INTERFACE_1_123_INTERFACE_NAME)));
  assert_int_equal(MY_INTERFACE._internal.intf_version, MY_INTERFACE_1_123_INTERFACE_VERSION);
