...
static void create_test_default_multibuffer(az_ulib_ustream* ustream)
{
  ...
  ASSERT_ARE_EQUAL(
      int,
      AZ_ULIB_SUCCESS,
      az_ulib_ustream_concat(ustream, &default_buffer2, default_multi_data1, free));
  ASSERT_ARE_EQUAL(
      int,
      AZ_ULIB_SUCCESS,
      az_ulib_ustream_concat(ustream, &default_buffer3, default_multi_data2, free));
...
TEST_FUNCTION(az_ulib_ustream_concat_multiple_buffers_succeed)
{
  ...
  az_ulib_result result1 = az_ulib_ustream_init(
      &test_buffer1,
      control_block1,
      free,
      USTREAM_COMPLIANCE_LOCAL_EXPECTED_CONTENT_1,
  ...
  az_ulib_result result2 = az_ulib_ustream_init(
      &test_buffer2,
      control_block2,
      free,
      USTREAM_COMPLIANCE_LOCAL_EXPECTED_CONTENT_2,
  ...
  az_ulib_result result3 = az_ulib_ustream_init(
      &test_buffer3,
      control_block3,
      free,
      USTREAM_COMPLIANCE_LOCAL_EXPECTED_CONTENT_3,
...
/* az_ulib_ustream_concat shall return AZ_ULIB_ILLEGAL_ARGUMENT_ERROR if the provided ustream is
 * NULL */
...
/* az_ulib_ustream_concat shall return AZ_ULIB_ILLEGAL_ARGUMENT_ERROR if the provided ustream to add
 * is NULL */
...
/* az_ulib_ustream_concat shall return AZ_ULIB_ILLEGAL_ARGUMENT_ERROR if the provided multi data to
 * add is NULL */
...
TEST_FUNCTION(az_ulib_ustream_multi_read_clone_and_original_in_parallel_succeed)
{
  ...
  ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_reset(&multibuffer));
...
/* az_ulib_ustream_split shall return AZ_ULIB_NO_SUCH_ELEMENT_ERROR if the provided split position
 * is invalid */
...
/* az_ulib_ustream_split shall return AZ_ULIB_ILLEGAL_ARGUMENT_ERROR if the provided split position
 * is invalid */
