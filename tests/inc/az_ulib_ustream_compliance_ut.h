...
TEST_FUNCTION(az_ulib_ustream_dispose_compliance_cloned_instance_disposed_first_succeed)
{
    ...
    az_ulib_result result = az_ulib_ustream_clone(&ustream_instance_clone, &ustream_instance, 0);
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_get_position(&ustream_instance, &ustream_clone_current_position));
        
    ///cleanup
    (void)az_ulib_ustream_dispose(&ustream_instance);
}

TEST_FUNCTION(az_ulib_ustream_dispose_compliance_cloned_instance_disposed_second_succeed)
{
    ///arrange
    offset_t ustream_clone_current_position;
    az_ulib_ustream ustream_instance;
...
TEST_FUNCTION(az_ulib_ustream_dispose_compliance_single_instance_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ///act
    az_ulib_result result = az_ulib_ustream_dispose(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_clone_compliance_new_buffer_cloned_with_zero_offset_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(
        int,
        AZ_ULIB_SUCCESS,
        az_ulib_ustream_reset(&ustream_instance_clone));
    ASSERT_ARE_EQUAL(
        int,
        AZ_ULIB_SUCCESS,
        az_ulib_ustream_get_position(&ustream_instance_clone, &ustream_clone_current_position));
...
TEST_FUNCTION(az_ulib_ustream_clone_compliance_new_buffer_cloned_with_offset_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ///act
    az_ulib_result result = az_ulib_ustream_clone(&ustream_instance_clone, &ustream_instance, 10000);
    ...
    /* release position was moved to the start menus one. */
    ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_reset(&ustream_instance_clone));
    ASSERT_ARE_EQUAL(
        int,
        AZ_ULIB_SUCCESS,
        az_ulib_ustream_get_position(&ustream_instance_clone, &ustream_clone_current_position));
...
TEST_FUNCTION(az_ulib_ustream_clone_compliance_empty_buffer_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_clone_compliance_new_buffer_with_non_zero_current_and_released_positions_cloned_with_offset_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_read(&ustream_instance, buf, USTREAM_COMPLIANCE_LENGTH_2, &size));
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_release(&ustream_instance, USTREAM_COMPLIANCE_LENGTH_1));
    az_ulib_ustream ustream_instance_clone;

    ///act
    az_ulib_result result =
        az_ulib_ustream_clone(&ustream_instance_clone, &ustream_instance, 100);
...
TEST_FUNCTION(az_ulib_ustream_clone_compliance_new_buffer_with_non_zero_current_and_released_positions_cloned_with_negative_offset_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ///act
    az_ulib_result result =
        az_ulib_ustream_clone(&ustream_instance_clone, &ustream_instance, USTREAM_COMPLIANCE_LENGTH_1);
...
TEST_FUNCTION(az_ulib_ustream_clone_compliance_cloned_buffer_with_non_zero_current_and_released_positions_cloned_with_offset_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_read(&ustream_instance, buf, USTREAM_COMPLIANCE_LENGTH_1, &size));
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_release(&ustream_instance, USTREAM_COMPLIANCE_LENGTH_1 - 1));
    az_ulib_ustream ustream_instance_clone1;
    az_ulib_result result = az_ulib_ustream_clone(&ustream_instance_clone1, &ustream_instance, 100);
    ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, result);
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
    ...
    /* release position was moved to the start menus one. */
    ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_reset(&ustream_instance_clone2));
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_get_position(&ustream_instance_clone2, &ustream_clone_current_position));
...
TEST_FUNCTION(az_ulib_ustream_get_remaining_size_compliance_new_buffer_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ///act
    az_ulib_result result = az_ulib_ustream_get_remaining_size(&ustream_instance, &size);
...
TEST_FUNCTION(az_ulib_ustream_get_remaining_size_compliance_new_buffer_with_non_zero_current_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_get_remaining_size_compliance_cloned_buffer_with_non_zero_current_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(
        ...
        az_ulib_ustream_release(&ustream_instance, USTREAM_COMPLIANCE_LENGTH_1 - 1));
    az_ulib_ustream ustream_instance_clone;
    az_ulib_result result = az_ulib_ustream_clone(&ustream_instance_clone, &ustream_instance, 100);
    ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, result);
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
...
TEST_FUNCTION(az_ulib_ustream_get_remaining_size_compliance_null_size_failed)
{
    ...
    ///act
    az_ulib_result result = az_ulib_ustream_get_remaining_size(&ustream_instance, NULL);
...
TEST_FUNCTION(az_ulib_ustream_get_current_position_compliance_new_buffer_succeed)
{
    ...
    ///act
    az_ulib_result result = az_ulib_ustream_get_position(&ustream_instance, &position);
...
TEST_FUNCTION(az_ulib_ustream_get_current_position_compliance_new_buffer_with_non_zero_current_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_get_current_position_compliance_cloned_buffer_with_non_zero_current_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_get_current_position_compliance_null_position_failed)
{
    ...
    ///act
    az_ulib_result result = az_ulib_ustream_get_position(&ustream_instance, NULL);
...
TEST_FUNCTION(az_ulib_ustream_read_compliance_get_from_original_buffer_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_read_compliance_get_from_cloned_buffer_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_set_position(&ustream_instance, USTREAM_COMPLIANCE_LENGTH_1));
    az_ulib_ustream ustream_instance_clone;
    az_ulib_result result =
        az_ulib_ustream_clone(&ustream_instance_clone, &ustream_instance, 100);
    ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, result);
...
TEST_FUNCTION(az_ulib_ustream_read_compliance_single_buffer_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_read_compliance_right_boundary_condition_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_read_compliance_cloned_buffer_right_boundary_condition_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_set_position(&ustream_instance, USTREAM_COMPLIANCE_EXPECTED_CONTENT_LENGTH - 1));
    az_ulib_ustream ustream_instance_clone;
    az_ulib_result result =
        az_ulib_ustream_clone(&ustream_instance_clone, &ustream_instance, 0);
    ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, result);
    (void)az_ulib_ustream_dispose(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_read_compliance_boundary_condition_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_read_compliance_left_boundary_condition_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_read_compliance_single_byte_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ///act
    az_ulib_result result = az_ulib_ustream_read(&ustream_instance, buf_result, 1, &size_result);
...
TEST_FUNCTION(az_ulib_ustream_read_compliance_buffer_with_zero_size_failed)
{
    ...
    ///act
    az_ulib_result result = az_ulib_ustream_read(&ustream_instance, buf_result, 0, &size_result);
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_back_to_beginning_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ///act
    az_ulib_result result = az_ulib_ustream_set_position(&ustream_instance, 0);
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_back_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_forward_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_read(&ustream_instance, buf_result, USTREAM_COMPLIANCE_LENGTH_1, &size_result));

    ///act
    az_ulib_result result = az_ulib_ustream_set_position(&ustream_instance, USTREAM_COMPLIANCE_LENGTH_2);
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_forward_to_the_end_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_run_full_buffer_byte_by_byte_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    {
        ///act - assert
        ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_set_position(&ustream_instance, i));
        
        ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS,
                az_ulib_ustream_read(&ustream_instance, buf_result, 1, &size_result));
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_run_full_buffer_byte_by_byte_reverse_order_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_set_position(&ustream_instance, 0));
    check_buffer(
        &ustream_instance, 
        0, 
        USTREAM_COMPLIANCE_LOCAL_EXPECTED_CONTENT, 
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_cloned_buffer_back_to_beginning_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_read(&ustream_instance_clone, buf_result, USTREAM_COMPLIANCE_LENGTH_1, &size_result));
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_cloned_buffer_back_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ///act
    result = 
        az_ulib_ustream_set_position(&ustream_instance_clone, USTREAM_COMPLIANCE_LENGTH_1);
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_cloned_buffer_forward_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_cloned_buffer_forward_to_the_end_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_cloned_buffer_run_full_buffer_byte_by_byte_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    {
        ///act - assert
        ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_set_position(&ustream_instance_clone, i));
        
        ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS,
                az_ulib_ustream_read(&ustream_instance_clone, buf_result, 1, &size_result));
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_cloned_buffer_run_full_buffer_byte_by_byte_reverse_order_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_set_position(&ustream_instance_clone, 0));
    check_buffer(
        &ustream_instance_clone, 
        USTREAM_COMPLIANCE_LENGTH_1, 
        USTREAM_COMPLIANCE_LOCAL_EXPECTED_CONTENT, 
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_forward_out_of_the_buffer_failed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_back_before_first_valid_position_failed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
/* If the provided position is before the first valid position, the set_position shall return AZ_ULIB_NO_SUCH_ELEMENT_ERROR, and do not change the current position. */
TEST_FUNCTION(az_ulib_ustream_set_position_compliance_back_before_first_valid_position_with_offset_failed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_release_compliance_succeed)
{
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_get_position(&ustream_instance, &current_position));

    ///act
    az_ulib_result result = az_ulib_ustream_release(&ustream_instance, current_position - 1);
...
TEST_FUNCTION(az_ulib_ustream_release_compliance_release_all_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ///assert
    ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, result);
    ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_reset(&ustream_instance));
    check_buffer(
        &ustream_instance, 
        USTREAM_COMPLIANCE_EXPECTED_CONTENT_LENGTH, 
        USTREAM_COMPLIANCE_LOCAL_EXPECTED_CONTENT, 
...
TEST_FUNCTION(az_ulib_ustream_release_compliance_run_full_buffer_byte_by_byte_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    {
        ///act - assert
        ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_set_position(&ustream_instance, i + 1));
    
        ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_release(&ustream_instance, i - 1));
...
TEST_FUNCTION(az_ulib_ustream_release_compliance_cloned_buffer_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_get_position(&ustream_instance_clone, &current_position));
...
TEST_FUNCTION(az_ulib_ustream_release_compliance_cloned_buffer_release_all_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    az_ulib_ustream ustream_instance_clone;
    az_ulib_result result =
        az_ulib_ustream_clone(&ustream_instance_clone, &ustream_instance, 1000);
    ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, result);
    (void)az_ulib_ustream_dispose(&ustream_instance);
    ASSERT_ARE_EQUAL(
            int, 
...
TEST_FUNCTION(az_ulib_ustream_release_compliance_cloned_buffer_run_full_buffer_byte_by_byte_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    {
        ///act - assert
        ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_set_position(&ustream_instance_clone, i + 1));
    
        ASSERT_ARE_EQUAL(int, AZ_ULIB_SUCCESS, az_ulib_ustream_release(&ustream_instance_clone, i - 1));
...
TEST_FUNCTION(az_ulib_ustream_release_compliance_release_after_current_failed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ///act
    az_ulib_result result = az_ulib_ustream_release(&ustream_instance, current_position);
...
TEST_FUNCTION(az_ulib_ustream_release_compliance_release_position_already_released_failed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_read(&ustream_instance, buf_result, USTREAM_COMPLIANCE_LENGTH_2, &size_result));
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_release(&ustream_instance, USTREAM_COMPLIANCE_LENGTH_2 - 1));
...
TEST_FUNCTION(az_ulib_ustream_reset_compliance_back_to_beginning_succeed)
{
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_read(&ustream_instance, buf_result, 5, &size_result));

    ///act
    az_ulib_result result = az_ulib_ustream_reset(&ustream_instance);
...
TEST_FUNCTION(az_ulib_ustream_reset_compliance_back_position_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
    ...
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_read(&ustream_instance, buf_result, USTREAM_COMPLIANCE_TEMP_BUFFER_LENGTH, &size_result));
    ASSERT_ARE_EQUAL(
        int, 
        AZ_ULIB_SUCCESS, 
        az_ulib_ustream_release(&ustream_instance, USTREAM_COMPLIANCE_LENGTH_1 - 1));
...
TEST_FUNCTION(az_ulib_ustream_reset_compliance_cloned_buffer_succeed)
{
    ///arrange
    az_ulib_ustream ustream_instance;
    USTREAM_COMPLIANCE_TARGET_FACTORY(&ustream_instance);
