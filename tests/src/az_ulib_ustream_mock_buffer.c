...
void set_set_position_result(az_ulib_result result) { _concrete_set_position_result = result; }

void set_reset_result(az_ulib_result result) { _concrete_reset_result = result; }

void set_read_result(az_ulib_result result) { _concrete_read_result = result; }
...
void set_get_position_result(az_ulib_result result) { _concrete_get_position_result = result; }

void set_release_result(az_ulib_result result) { _concrete_release_result = result; }

void set_clone_result(az_ulib_result result) { _concrete_clone_result = result; }

void set_dispose_result(az_ulib_result result) { _concrete_dispose_result = result; }
