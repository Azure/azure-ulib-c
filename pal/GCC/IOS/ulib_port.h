...
#ifndef AZULIB_GCC_IOS_PORT_H
#define AZULIB_GCC_IOS_PORT_H


// This iOS-specific header offers 3 strategies:
//   AZULIB_ATOMIC_DONTCARE     -- no atomicity guarantee
//   AZULIB_USE_STD_ATOMIC      -- C11 atomicity
//   AZULIB_USE_GNU_C_ATOMIC    -- GNU-specific atomicity

#if defined(__GNUC__)
#define AZULIB_USE_GNU_C_ATOMIC 1
#endif

#if defined(__STDC_VERSION__) && (__STDC_VERSION__ == 201112)
#define AZULIB_USE_STD_ATOMIC 1
#undef AZULIB_USE_GNU_C_ATOMIC
#endif

#if defined(AZULIB_ATOMIC_DONTCARE)
#define COUNT_TYPE uint32_t
#elif defined(AZULIB_USE_STD_ATOMIC)
#define COUNT_TYPE _Atomic uint32_t
#else  // AZULIB_USE_GNU_C_ATOMIC
#define COUNT_TYPE uint32_t
#endif // defined(AZULIB_ATOMIC_DONTCARE)
...
AZULIB_ATOMIC_DONTCARE does not use atomic operations
...
#elif defined(AZULIB_USE_GNU_C_ATOMIC)
...
#endif /*defined(AZULIB_USE_GNU_C_ATOMIC)*/

#define AZULIB_PORT_THROW_HARD_FAULT      (*(char*)NULL = 0)

#endif // AZULIB_GCC_IOS_PORT_H
