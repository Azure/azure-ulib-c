...
/**
 * @brief Signature of the function to be invoked by the `az_ulib_ustream_forward_flush` operation 
 *        when the `const uint8_t* const` to the buffer has been created.
 * 
 ...
 * @param[in]   flush_callback_context  The #az_ulib_callback_context contract held between the owner  
 *                                      of this callback and the caller of 
 ...
 *                                            with success.
 */
AZ_NODISCARD AZ_INLINE az_result az_ulib_ustream_forward_dispose(az_ulib_ustream_forward* ustream_forward)
{
