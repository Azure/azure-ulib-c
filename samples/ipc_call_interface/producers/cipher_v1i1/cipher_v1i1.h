...
#include <stdint.h>
  ...
  int8_t cipher_v1i1_alpha_get(void);
  void cipher_v1i1_alpha_set(const int8_t val);

  uint32_t cipher_v1i1_delta_get(void);
  void cipher_v1i1_delta_set(const uint32_t val);
