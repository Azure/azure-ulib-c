...
const char* const AZ_ULOG_REQUIRE_EQUALS_STRING = "%s requires equals %s\r\n";
const char* const AZ_ULOG_REQUIRE_NOT_EQUALS_STRING = "%s requires not equals %s\r\n";
const char* const AZ_ULOG_REQUIRE_NOT_NULL_STRING = "%s cannot be null\r\n";
const char* const AZ_ULOG_REQUIRE_NULL_STRING = "%s shall be null\r\n";
const char* const AZ_ULOG_REQUIRE_TYPE_OF_USTREAM_STRING = "ustream is not the correct type\r\n";
