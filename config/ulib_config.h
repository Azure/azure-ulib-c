...
#ifndef AZULIB_ULIB_CONFIG_H
#define AZULIB_ULIB_CONFIG_H
 ...
 */
#define AZULIB_ULIB_CONFIG_MALLOC(size)    azulib_ulib_malloc(size)
 ...
 */
#define AZULIB_ULIB_CONFIG_FREE(ptr)       azulib_ulib_free(ptr)
 ...
 *      log system.
 */
#define AZULIB_ULIB_CONFIG_LOG(category, format, ...)  azulib_ulog_print(category, format, ##__VA_ARGS__)
 ...
 */
#define AZULIB_ULIB_CONFIG_MAX_LOG_SIZE        256

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif /* AZULIB_ULIB_CONFIG_H */
